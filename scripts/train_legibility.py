...
away. ResNet-18 binary fine-tune; rebuild data + re-run as labels grow.
  ...
  python scripts/train_legibility.py     # -> runs/jersey/legibility_resnet18.pt + report
"""
...
CLASSES = ("illegible", "legible")      # index = label
...
def main() -> int:
    ...
    ap.add_argument("--data", default="data/jersey_dataset/legibility")
    ap.add_argument("--epochs", type=int, default=15)
    ap.add_argument("--batch", type=int, default=32)
    ap.add_argument("--lr", type=float, default=3e-4)
    ap.add_argument("--out", default="runs/jersey/legibility_resnet18.pt")
    a = ap.parse_args()
